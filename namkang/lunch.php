<?php
    ...
    function get_lunch($code, $type)
    {
        ...
        {
            $url = "https://stu.sen.go.kr/sts_sci_md00_001.do?domainCode=B10&schulCode=".$code."&schulCrseScCode=4&ay=".date("Y", strtotime("+1 day"))."&mm=".date("m", strtotime("+1 day"));
            $next = true;
        }
        else
            $url = "https://stu.sen.go.kr/sts_sci_md00_001.do?domainCode=B10&schulCode=".$code."&schulCrseScCode=4";
